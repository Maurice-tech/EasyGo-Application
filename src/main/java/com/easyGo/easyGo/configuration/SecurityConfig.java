package com.easyGo.easyGo.configuration;



import com.easyGo.easyGo.security.JWTAuthenticationFilter;
import com.easyGo.easyGo.security.JwtAuthEntryPoint;
...
//                        .requestMatchers(antMatcher("/javainuse-openapi/**")).permitAll()
                        ...
                        // Driver Task
                        .requestMatchers(antMatcher(HttpMethod.POST, "/api/v1/drivers/task_status")).hasAnyAuthority("DRIVER")
                        .requestMatchers(antMatcher(HttpMethod.GET, "/api/v1/drivers/orders")).hasAnyAuthority("DRIVER")
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://ec2-3-92-84-84.compute-1.amazonaws.com:8085", "http://localhost:2006", "localhost:2006"));
